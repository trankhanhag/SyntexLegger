...
const BudgetAllocationModule: React.FC = () => {
    ...
    const renderList = () => (
        <div className="bg-white rounded-lg shadow-sm p-6 h-full flex flex-col">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h2 className="text-xl font-bold text-gray-800">Phân bổ Dự toán</h2>
                    <p className="text-sm text-gray-500">Quản lý phân bổ ngân sách cho các đơn vị trực thuộc</p>
                </div>
                <button
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {allocations.length === 0 ? (
                            ...
                            // though simpler API response might include it joined.
                            // Assuming API returns joined data or we map manualy if needed.
                            // For MVP, just showing allocating amounts.
                            return (
                                <tr key={item.id} className="hover:bg-gray-50">
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        {/* Ideally look up item code from estimates map if not in item object */}
    ...
    const renderCreateForm = () => {
        ...
        return (
            <div className="bg-white rounded-lg shadow-sm p-6 max-w-2xl mx-auto mt-8">
                <h3 className="text-lg font-bold text-gray-900 mb-6">Tạo mới Phân bổ Ngân sách</h3>
